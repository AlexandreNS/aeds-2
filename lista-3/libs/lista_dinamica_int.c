...
int remove_ultimoLista(Lista* l, int* v){
...
int remove_posicaoLista(Lista* l, int p, int* v){
  Elemento *aux = l->inicio;
...
int recupera_chaveLista(Lista* l, int v){
  Elemento *aux = l->inicio;
...
int recupera_posicaoLista(Lista* l, int p, int *v){
  Elemento *aux = l->inicio;
  int count = 1;
